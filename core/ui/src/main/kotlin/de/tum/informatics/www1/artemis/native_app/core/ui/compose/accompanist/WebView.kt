package de.tum.informatics.www1.artemis.native_app.core.ui.compose.accompanist

// The accompanist WebView has been deprecated with the note that one may fork the library and
// maintain it themselves. This is a copy of the WebView.kt file from the accompanist library.
// The original file can be found here: https://github.com/google/accompanist/blob/main/web/src/main/java/com/google/accompanist/web/WebView.kt
...
import de.tum.informatics.www1.artemis.native_app.core.ui.compose.accompanist.LoadingState.Finished
import de.tum.informatics.www1.artemis.native_app.core.ui.compose.accompanist.LoadingState.Loading
