 ...
 */
sealed class MetisContext(val postPathSegments: List<String>, val resourceEndpoint: String) {
    abstract val courseId: Int

    data class Course(override val courseId: Int) :
        MetisContext(listOf("courses", courseId.toString(), "discussion"), "posts")
