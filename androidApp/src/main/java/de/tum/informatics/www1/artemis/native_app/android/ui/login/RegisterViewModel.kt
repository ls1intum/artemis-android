...
import de.tum.informatics.www1.artemis.native_app.android.defaults.Constants
...
class RegisterViewModel(private val savedStateHandle: SavedStateHandle) : ViewModel() {
    ...
    val confirmPasswordStatus: Flow<ConfirmationPasswordStatus> = confirmPassword.map { confirmPassword ->
        when {
