...
val primaryLight = Color(0xff3e8acc) // Artemis Blue try to change
val onPrimaryLight = Color(0xFFFFFFFF)
val primaryContainerLight = Color(0xff3e8acc) //use artemis where we use this color
...
val backgroundLight = Color(0xFFFFFFFF) //0xFFF8F9FF
...
val surfaceContainerLight = Color(0xfff2f2f2) //FFF1F1F1
